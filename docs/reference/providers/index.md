...
Temper AI supports **7 LLM providers**. Set the provider in your [agent config](../agents/llm.md) or workflow `defaults:`.
...
| [`claude_v2`](claude_v2.md) | Interactive, tmux-driven Claude Code. Drop-in BaseLLM, contract-parity |
