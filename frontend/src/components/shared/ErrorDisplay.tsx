...
export function ErrorDisplay({ error, compact }: ErrorDisplayProps) {
  ...
  if (compact) {
    return (
      <div className="px-2 py-0.5 rounded text-[10px] bg-red-950/50 text-red-400 truncate" title={error}>
        {error}
      </div>
    );
  }
  ...
  return (
    <div className="rounded-md bg-red-950/30 border border-red-900/30 p-3 text-sm text-red-400">
