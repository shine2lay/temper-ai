...
export function WorkflowSettingsOverlay() {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="px-3 py-2 border-b border-temper-border/50 flex items-center justify-between">
        <span className="text-xs font-semibold text-temper-text">Workflow Settings</span>
        <button
