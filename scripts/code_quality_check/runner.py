...
# Imports below require sys.path above so they resolve when this script runs
# standalone (`python scripts/code_quality_check/runner.py`).
from scripts.code_quality_check.base import (  # noqa: E402
    ExternalToolRule,
    Finding,
    ScanContext,
    Severity,
...
from scripts.code_quality_check.rules import discover_rules  # noqa: E402
