...
from src.agent.models.response import AgentResponse, ToolCallRecord  # noqa: F401
from src.agent.utils.constants import OUTPUT_PREVIEW_LENGTH
from src.shared.core.context import ExecutionContext  # canonical definition; re-exported here
...
class BaseAgent(ABC):
    ...
    def _build_error_response(
        ...
        from src.shared.utils.exceptions import sanitize_error_message
    ...
    def _inject_input_context(
        ...
        """
        from src.llm.prompts.validation import _is_safe_template_value
