...
from src.agent.strategies.constants import (
...
class StrategyRegistry:
    ...
    def _register_strategy(self, names: List[str], module_path: str, class_name: str) -> None:
        ...
        Args:
            ...
            module_path: Python module path (e.g., "src.agent.strategies.debate")
    ...
    def _initialize_defaults(self) -> None:
        ...
        strategies = [
            ([STRATEGY_NAME_CONSENSUS], "src.agent.strategies.consensus", "ConsensusStrategy"),
            (["debate", "debate_and_synthesize", "llm_debate_and_synthesize"],
             "src.agent.strategies.debate", "DebateAndSynthesize"),
            (["dialogue"], "src.agent.strategies.dialogue", "DialogueOrchestrator"),
            (["multi_round"], "src.agent.strategies.multi_round", "MultiRoundStrategy"),
            (["leader"], "src.agent.strategies.leader", "LeaderCollaborationStrategy"),
        ]
        ...
        resolvers = {
            STRATEGY_NAME_MERIT_WEIGHTED: ("src.agent.strategies.merit_weighted", "MeritWeightedResolver"),
            "highest_confidence": ("src.agent.strategies.conflict_resolution", "HighestConfidenceResolver"),
            "random_tiebreaker": ("src.agent.strategies.conflict_resolution", "RandomTiebreakerResolver"),
            "human_escalation": ("src.agent.strategies.merit_weighted", "HumanEscalationResolver"),
        }
