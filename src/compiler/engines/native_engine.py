...
class NativeExecutionEngine(ExecutionEngine):
    ...
    def _initialize_components(self) -> None:
        ...
        from src.compiler.engines.native_runner import ThreadPoolParallelRunner
    ...
    def _validate_stage_config(
        ...
        from src.compiler.constants import ERROR_MSG_STAGE_PREFIX
    ...
    def _validate_agent_configs_for_stage(
        ...
        from src.compiler.constants import ERROR_MSG_AGENT_PREFIX
        from src.compiler.langgraph_compiler import _extract_agents_from_stage
