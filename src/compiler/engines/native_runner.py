"""ThreadPool-based parallel runner for the native execution engine.

Replaces LangGraphParallelRunner with a pure-Python implementation using
concurrent.futures.ThreadPoolExecutor. No LangGraph dependency.
