...
from src.goals.constants import DEFAULT_DATABASE_URL, DEFAULT_LIST_LIMIT, DEFAULT_RUN_LIMIT
...
class GoalStore:
    ...
    def update_proposal_status(
        ...
        from src.storage.database.datetime_utils import utcnow as _utcnow
