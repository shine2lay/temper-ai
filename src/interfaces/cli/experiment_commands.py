...
Usage:
    ...
    maf experiment create     Create experiment from YAML
    maf experiment start      Start an experiment
    maf experiment stop       Stop an experiment
    maf experiment results    Show experiment results
"""
