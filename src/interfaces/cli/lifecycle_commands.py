...
Usage:
    maf lifecycle profiles              List all profiles (YAML + DB)
    maf lifecycle profiles show <name>  Show profile rules
    maf lifecycle classify <wf> -i <f>  Classify project characteristics
    maf lifecycle preview <wf> -i <f>   Dry-run: show what would be adapted
    maf lifecycle history               Show recent adaptation records
    maf lifecycle check                 Run rollback check on active profiles
"""
