...
def _load_and_validate_workflow(
    ...
    """
    from src.workflow._schemas import WorkflowConfig as WorkflowConfigSchema
...
def _display_detailed_report(result: Any) -> None:
    ...
    if not isinstance(result, dict):
        return
    try:
        from src.interfaces.cli.detail_report import print_detailed_report
...
def _validate_source_references(
    ...
    """
    from src.workflow.dag_builder import build_stage_dag
...
def _check_workflow_file(
    ...
    try:
        from src.workflow._schemas import WorkflowConfig as WfSchema
        WfSchema(**wf_config)
    except Exception as exc:  # noqa: BLE001
