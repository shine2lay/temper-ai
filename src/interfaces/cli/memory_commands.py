...
Usage:
    maf memory list    --tenant --workflow --agent [--type]
    maf memory add     --tenant --workflow --agent --type
    maf memory search  --tenant --workflow --agent --query
    maf memory clear   --tenant --workflow --agent --confirm
    maf memory seed    <seed-file.yaml>
"""
...
# Memory type values (mirrors src.memory.constants to avoid cross-module import)
