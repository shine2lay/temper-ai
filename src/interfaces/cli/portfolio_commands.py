...
Usage:
    maf portfolio list                       List available portfolios
    maf portfolio show <name>                Show portfolio details + allocation status
    maf portfolio run <name> [--product X]   Run next product (or specific)
    maf portfolio scorecards <name>          Show product scorecards
    maf portfolio recommend <name>           Show invest/sunset recommendations
    maf portfolio components <name>          Analyze cross-product component sharing
    maf portfolio graph stats                Knowledge graph statistics
    maf portfolio graph query <concept>      Query related concepts
"""
...
def _get_store(db: str) -> "PortfolioStore":
    ...
    from src.portfolio.store import PortfolioStore as _Store
...
def _get_loader(config_dir: str) -> "PortfolioLoader":
    ...
    from src.portfolio.loader import PortfolioLoader as _Loader
