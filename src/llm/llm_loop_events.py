...
Canonical location: ``src/llm/llm_loop_events.py``
(moved from ``src/observability/llm_loop_events.py`` to fix a layer
violation -- infrastructure (llm) was importing from cross_cutting
