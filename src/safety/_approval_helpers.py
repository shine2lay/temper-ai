...
if TYPE_CHECKING:
    from src.safety.approval import ApprovalRequest
...
def evict_oldest_completed(
    ...
    completed_ids = [
        rid for rid, req in requests.items()
...
def check_approver_authorized(
    ...
    authorized_approvers: Optional[frozenset],
) -> Optional[str]:
...
def expire_request(request: "ApprovalRequest") -> None:
    ...
    if request.is_pending():
        from src.safety.approval import ApprovalStatus
