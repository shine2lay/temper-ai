...
from src.safety.policies._rate_limit_helpers import check_limit, format_wait_time
...
class TokenBucketRateLimitPolicy(BaseSafetyPolicy):
    ...
    For window-based limiting, see ``WindowRateLimitPolicy`` in ``src.safety.rate_limiter``.
    """
