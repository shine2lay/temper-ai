...
def load_state(storage: Any, name: str) -> dict:
    ...
    """
    from src.shared.core.circuit_breaker import CircuitBreakerConfig, CircuitState
...
def reserve_execution(breaker: Any) -> Optional[Any]:
    ...
    """
    from src.shared.core.circuit_breaker import CircuitBreakerError, CircuitState
