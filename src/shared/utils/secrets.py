...
from src.shared.constants.sizes import SIZE_10KB, SIZE_100KB
from src.shared.utils.constants import ERROR_SECRET_PREFIX
...
def detect_secret_patterns(text: str) -> Tuple[bool, Optional[str]]:
    ...
    **SECURITY:** Uses bounded quantifiers to prevent ReDoS (Regular Expression
    ...
    from src.shared.utils.secret_patterns import SECRET_PATTERNS
