...
class DynamicExecutionEngine(ExecutionEngine):
    ...
    def _initialize_components(self) -> None:
        ...
        from src.workflow.engines.dynamic_runner import ThreadPoolParallelRunner
    ...
    def _setup_predecessor_injection(self) -> None:
        ...
        """
        from src.workflow.context_provider import PredecessorResolver, SourceResolver
    ...
    def _validate_agent_configs_for_stage(
        ...
        from src.workflow.engines.langgraph_compiler import _extract_agents_from_stage
