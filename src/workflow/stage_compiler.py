...
Canonical location: ``src.workflow.stage_compiler``
(moved from ``src.stage.stage_compiler`` to break stage→workflow circular dep).
Re-exported from ``src.stage.stage_compiler`` for backward compatibility.
"""
import logging
...
from src.workflow.dag_builder import build_stage_dag, compute_depths, has_dag_dependencies
