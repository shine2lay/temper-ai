...
Usage:
    temper-ai goals list       List goal proposals
    temper-ai goals propose    Run analysis and generate proposals
    temper-ai goals review     Apply review decision to a proposal
    temper-ai goals approve    Shortcut to approve a proposal
    temper-ai goals reject     Shortcut to reject a proposal
    temper-ai goals status     Show acceptance rate and proposal stats
"""
