...
Usage:
    ...
    temper-ai learning patterns   List learned patterns
    temper-ai learning recommend  Generate recommendations from patterns
    temper-ai learning tune       Preview or apply auto-tune recommendations
    temper-ai learning stats      Show mining run history and convergence
"""
