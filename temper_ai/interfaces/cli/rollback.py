...
Example:
    ...
    python -m temper_ai.interfaces.cli rollback list --workflow-id wf-123 --limit 10

    # Get snapshot details
    python -m temper_ai.interfaces.cli rollback info snap-456

    # Dry run (preview without executing)
    python -m temper_ai.interfaces.cli rollback execute snap-456 \
