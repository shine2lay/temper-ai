...
Usage:
    temper-ai template list         List available product templates
    temper-ai template info <type>  Show template details and quality gates
    temper-ai template create       Generate project configs from a template
"""
