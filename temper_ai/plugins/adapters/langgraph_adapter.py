...
from temper_ai.plugins.constants import PLUGIN_DEFAULT_TIMEOUT, PLUGIN_TYPE_LANGGRAPH  # noqa: F401
...
class LangGraphAgent(ExternalAgentPlugin):
    ...
    def _initialize_external_agent(self) -> None:
        ...
        if not graph_module:
            raise ValueError("LangGraph plugin requires 'graph_module' in plugin_config")
