...
_LAZY_IMPORTS = {
    ...
    "SecretDetectionPolicy": ("temper_ai.safety.secret_detection", "SecretDetectionPolicy"),
    "WindowRateLimitPolicy": ("temper_ai.safety.rate_limiter", "WindowRateLimitPolicy"),
    "RateLimiterPolicy": ("temper_ai.safety.rate_limiter", "RateLimiterPolicy"),  # backward-compat alias
    "FileAccessPolicy": ("temper_ai.safety.file_access", "FileAccessPolicy"),
    "ForbiddenOperationsPolicy": ("temper_ai.safety.forbidden_operations", "ForbiddenOperationsPolicy"),
    # Policy composition
    "PolicyComposer": ("temper_ai.safety.composition", "PolicyComposer"),
    "CompositeValidationResult": ("temper_ai.safety.composition", "CompositeValidationResult"),
    # Approval workflow
    ...
    "ActionPolicyEngine": ("temper_ai.safety.action_policy_engine", "ActionPolicyEngine"),
    "PolicyExecutionContext": ("temper_ai.safety.action_policy_engine", "PolicyExecutionContext"),
    ...
    "CompositeRollbackStrategy": ("temper_ai.safety.rollback", "CompositeRollbackStrategy"),
    ...
    "CircuitBreakerMetrics": ("temper_ai.safety.circuit_breaker", "CircuitBreakerMetrics"),
    ...
    "CircuitBreakerManager": ("temper_ai.safety.circuit_breaker", "CircuitBreakerManager"),
    ...
    "TokenBucketRateLimitPolicy": ("temper_ai.safety.policies.rate_limit_policy", "TokenBucketRateLimitPolicy"),
    "RateLimitPolicy": ("temper_ai.safety.policies.rate_limit_policy", "RateLimitPolicy"),  # backward-compat alias
    "RateLimitPolicyV2": ("temper_ai.safety.policies.rate_limit_policy", "RateLimitPolicy"),  # backward-compat alias
    # Resource consumption limits
    "ResourceLimitPolicy": ("temper_ai.safety.policies.resource_limit_policy", "ResourceLimitPolicy"),
    # Service mixin
    "SafetyServiceMixin": ("temper_ai.safety.service_mixin", "SafetyServiceMixin"),
    # Exceptions
    "SafetyViolationException": ("temper_ai.safety.exceptions", "SafetyViolationException"),
    ...
    "ForbiddenOperationViolation": ("temper_ai.safety.exceptions", "ForbiddenOperationViolation"),
    ...
    "PromptInjectionDetectorProtocol": ("temper_ai.safety.interfaces", "PromptInjectionDetectorProtocol"),
    "OutputSanitizerProtocol": ("temper_ai.safety.interfaces", "OutputSanitizerProtocol"),
