...
class ScraperRateLimiter:
    """Rate limiter for web requests backed by :class:`~temper_ai.safety.token_bucket.TokenBucket`.
    ...
    def __init__(self, max_requests: int, time_window: int):
        ...
        """
        from temper_ai.safety.token_bucket import RateLimit, TokenBucket
