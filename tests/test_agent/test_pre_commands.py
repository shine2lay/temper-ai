...
from src.agent.utils._pre_command_helpers import (
    _render_command,
    _truncate,
    execute_pre_commands,
    format_pre_command_results,
)
from src.agent.utils.constants import PRE_COMMAND_MAX_OUTPUT_CHARS
from src.storage.schemas.agent_config import AgentConfig, PreCommand
...
class TestReExport:
    ...
    def test_pre_command_importable_from_compiler_schemas(self) -> None:
        from src.storage.schemas.agent_config import PreCommand as ReExportedPreCommand
