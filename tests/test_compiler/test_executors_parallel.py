...
class TestParallelExecution:
    ...
    def test_parallel_execution_with_n_agents(
        ...
        with patch('src.compiler.executors.parallel.AgentFactory.create') as mock_factory, \
             ...
             patch('src.strategies.base.SynthesisResult', return_value=mock_synthesis_result):
    ...
    def test_parallel_execution_is_concurrent(
        ...
        with patch('src.compiler.executors.parallel.AgentFactory.create') as mock_factory, \
             patch('src.compiler.schemas.AgentConfig'), \
             patch('src.strategies.base.SynthesisResult') as mock_synthesis_class:
...
class TestErrorHandling:
    ...
    def test_error_aggregation_in_state(
        ...
        with patch('src.compiler.executors.parallel.AgentFactory.create') as mock_factory, \
             patch('src.compiler.schemas.AgentConfig'), \
             patch('src.strategies.base.SynthesisResult'):
