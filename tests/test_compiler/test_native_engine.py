...
from src.compiler.engines.native_engine import (
...
class TestNativeExecutionEngine:
    ...
    def _make_engine(self):
        ...
        with patch("src.compiler.engines.native_engine.create_safety_stack") as mock_safety:
    ...
    def test_execute_wrong_type_raises(self):
        ...
        engine = self._make_engine()
        with pytest.raises(TypeError, match="NativeCompiledWorkflow"):
...
class TestEngineRegistration:
    ...
    def test_get_native_engine(self):
        ...
        registry = EngineRegistry()
        with patch("src.compiler.engines.native_engine.create_safety_stack") as mock:
