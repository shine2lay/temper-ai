...
from src.compiler.security_limits import CONFIG_SECURITY, ConfigSecurityLimits
...
class TestSecurityLimitUsage:
    ...
    def test_can_import_singleton(self):
        ...
        from src.compiler.security_limits import CONFIG_SECURITY as imported_singleton
    ...
    def test_can_import_class(self):
        ...
        from src.compiler.security_limits import ConfigSecurityLimits as ImportedClass
