...
class TestNativeExecutionEngine:
    ...
    def _make_engine(self):
        ...
        with patch("src.workflow.engines.native_engine.create_safety_stack") as mock_safety:
...
class TestEngineRegistration:
    ...
    def test_get_native_engine(self):
        ...
        registry = EngineRegistry()
        with patch("src.workflow.engines.native_engine.create_safety_stack") as mock:
